...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(name: "User de Ejemplo", email: "user@ejemplo.com",
  ...
  test "El name debe estar presente" do
    @user.name = "     "
  ...
  test "email validacion debe acceptar direcciones validas" do
    valid_addresses = %w[user@example.com USERS@foo.COM A_US-ER@foo.bar.org first.last@foo.jp alice+bob@baz.cn]
  ...
  test "associated proyects should be destroyed" do
    @user.save
    @user.proyects.create!(name: "Lorem ipsum", description: "value", value: 10000)
